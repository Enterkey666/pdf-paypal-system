"""
個別の履歴ファイルの支払いステータス更新APIエンドポイント

このファイルをapp.pyにインポートして使用します。
"""
...
# update_history_payment_statuses_apiエンドポイント
def register_update_history_api(app, admin_required, update_payment_status_by_order_id, logger):
    """
    app.pyに個別の履歴ファイルの支払いステータス更新APIエンドポイントを登録する関数
    """
    ...
    return update_history_payment_statuses_api
